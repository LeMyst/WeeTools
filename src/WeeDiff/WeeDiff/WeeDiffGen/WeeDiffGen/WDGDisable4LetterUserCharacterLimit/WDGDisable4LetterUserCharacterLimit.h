#ifndef _WDG_DISABLE_4_LETTER_USER_CHARACTER_LIMIT_H
#define _WDG_DISABLE_4_LETTER_USER_CHARACTER_LIMIT_H
...
#endif // _WDG_DISABLE_4_LETTER_USER_CHARACTER_LIMIT_H