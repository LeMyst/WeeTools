...
#include "WDGIncreaseZoomOutMax.h"
...
LPWDGPLUGININFO WDGPlugin::GetPluginInfo()
{
	...
	{
		TEXT("Increase Zoom Out Max"),
		TEXT("Allows you to zoom out as far as you want."),
		TEXT("[UI]"),
		TEXT(""),
		TEXT("Shinryo"),
		1,
		0,
		{ 0xe147b10b, 0x5766, 0x486f, { 0x8f, 0xcb, 0xfd, 0x41, 0xc6, 0xd4, 0xfc, 0x4d } }
	};
...
DiffData *WDGPlugin::GeneratePatch()
{
	...
	{
		sprintf_s(szMsg, 256, "WDGIncreaseZoomOutMax :: Part %d :: %s", uPart, lpszMsg);
		m_dgc->LogMsg(szMsg);
		return NULL;
	}
