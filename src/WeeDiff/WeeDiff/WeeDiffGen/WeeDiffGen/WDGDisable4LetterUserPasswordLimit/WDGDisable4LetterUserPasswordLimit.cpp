...
#include "WDGDisable4LetterUserPasswordLimit.h"
...
LPWDGPLUGININFO WDGPlugin::GetPluginInfo()
{
	...
	{
		TEXT("Disable 4 Letter User Password Limit"),
		TEXT("Removes the limit of min. 4 characters for the account password."),
		TEXT("[Fix]"),
		TEXT(""),
		TEXT("Shinryo"),
		1,
		0,
		{ 0x89458498, 0x3098, 0x4edf, { 0x9b, 0xbe, 0xb6, 0x89, 0x25, 0xc4, 0xdb, 0x13 } }
	};
...
DiffData *WDGPlugin::GeneratePatch()
{
	...
	try
	{
		...
		m_dgc->Replace(CBAddDiffData, offsets[1] + 7, &sFindData);
	}
