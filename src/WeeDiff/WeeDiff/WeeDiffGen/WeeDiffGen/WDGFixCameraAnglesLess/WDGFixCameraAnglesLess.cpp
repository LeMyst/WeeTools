...
#include "WDGFixCameraAnglesLess.h"
...
LPWDGPLUGININFO WDGPlugin::GetPluginInfo()
{
	...
	{
		TEXT("Fix Camera Angles Less"),
		TEXT("Allows you to rotate around the x-axis for almost 30 degrees."),
		TEXT("[UI]"),
		TEXT(""),
		TEXT("Shinryo"),
		1,
		0,
		{ 0xa671b82b, 0xbfc5, 0x46a8, { 0xba, 0x82, 0x11, 0x9c, 0x2c, 0x43, 0x8a, 0x59 } }
	};
...
DiffData *WDGPlugin::GeneratePatch()
{
	...
	{
		sprintf_s(szMsg, 256, "WDGFixCameraAnglesLess :: Part %d :: %s", uPart, lpszMsg);
		m_dgc->LogMsg(szMsg);
		return NULL;
	}
